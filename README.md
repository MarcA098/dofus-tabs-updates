...
Dofus Tabs Organizer es una aplicación de escritorio desarrollada en Electron para facilitar la gestión de múltiples ventanas de **Dofus Unity** y **Dofus Retro**, especialmente pensada para jugadores multicuenta.
...
- El usuario debe descargar la nueva versión manualmente
